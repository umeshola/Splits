...
export default function Disney() {
    ...
    return (
        <div>
                ...
                <div className='bg-neutral-800 relative rounded-3xl w-[350px] h-[500px] shadow-neutral-950 shadow-[0px_0px_250px_200px_rgba(0,0,0,0.25)]'>
                    ...
                    <div className='flex mt-[20px] w-[270px] ml-10 justify-center border-[1px] rounded-xl border-neutral-900 bg-neutral-950'>
                        <button
                            ...
                            <span className='group-hover/btn:opacity-100 block transition duration-500 opacity-0 absolute h-px w-full -bottom-px inset-x-0 bg-gradient-to-r from-transparent via-purple-800 to-transparent'></span>
                            <span className='group-hover/btn:opacity-100 blur-sm block transition duration-500 opacity-0 absolute h-px w-1/2 mx-auto -bottom-px inset-x-10 bg-gradient-to-r from-transparent via-purple-900 to-transparent'></span>
                        </button>
                    </div>
                </div>
            </div>)}
            ...
            {(flag1 || flag2) ? null : <div className='sm:h-[540px] h-[600px] w-[360px] sm:w-[800px] shadow-neutral-950 shadow-[0px_0px_100px_10px_rgba(0,0,0,0.25)] bg-neutral-900 rounded-lg border-[1px] border-neutral-900'>
                <div className='flex justify-center  mt-[25px] sm:mt-[25px]'>
                    <div className='border-[1px] min-h-[350px] pt-4 px-4 border-neutral-800 bg-neutral-800 shadow-neutral-900 shadow-[0px_0px_10px_2px_rgba(0,0,0,0.25)] bg-opacity-45 rounded-2xl'>
                        <div className='border-[1px] border-neutral-800 px-1 py-1 rounded-2xl bg-neutral-800 bg-opacity-45'>
                            <div>
                                <h1 className='text-[18px] sm:text-[22px]'>Super</h1>
                            </div>
                            <div className='flex'>
                                <div>
                        ...
                        <div className=' flex mt-[25px] mb-2 justify-center border-[1px] rounded-xl border-neutral-900 bg-neutral-950'>
                            <button onClick={handleSuperQR} className="bg-gradient-to-br bg-neutral-950 relative group/btn block w-full text-white rounded-xl h-10 font-medium" type='submit'>Buy plan
                                <span className='group-hover/btn:opacity-100 block transition duration-500 opacity-0 absolute h-px w-full -bottom-px inset-x-0 bg-gradient-to-r from-transparent via-purple-800 to-transparent'></span>
                                <span className='group-hover/btn:opacity-100 blur-sm block transition duration-500 opacity-0 absolute h-px w-1/2 mx-auto -bottom-px inset-x-10 bg-gradient-to-r from-transparent via-purple-900 to-transparent'></span>
                            </button>
                        </div>
                                ...
                                <div className='border-[1px] w-fit bg-neutral-900 border-neutral-800 rounded-md'>
                                    <div>
                                        <select
                                            id='number-dd'
                                            name='number'
                                            className="bg-neutral-900 text-white border border-neutral-800 rounded-md p-1 focus:outline-none focus:ring-1 focus:ring-purple-900"
