...
export default function Disney() {
    ...
    return (
        <div>
            ...
            {(flag1 || flag2) ? null : <div className='sm:h-[540px] h-[600px] w-[460px] sm:w-[800px] shadow-neutral-950 shadow-[0px_0px_100px_10px_rgba(0,0,0,0.25)] bg-neutral-900 rounded-lg border-[1px] border-neutral-900'>
                <div className='flex justify-center  mt-[45px]'>
                    <div className='border-[1px] min-h-[350px] pt-4 px-4 border-neutral-800 bg-neutral-800 shadow-neutral-900 shadow-[0px_0px_10px_2px_rgba(0,0,0,0.25)] bg-opacity-45 rounded-2xl'>
                        <div className='border-[1px] border-neutral-800 px-1 py-1 rounded-2xl bg-neutral-800 bg-opacity-45'>
                            <div>
                                <h1 className='text-[22px]'>Super</h1>
                            </div>
                            <div className='flex'>
                                <div>
                                ...
                                <div>
                                    <h1 className='text-neutral-500 text-[14px] mt-[11px] ml-[2px]'>/3month</h1>
                                </div>
                            </div>
                        </div>
