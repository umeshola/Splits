    ...
    return (
        <div>
            ...
            {flag2 ? null : <div className='sm:h-[540px] h-[600px] w-[360px] sm:w-[800px] shadow-neutral-950 shadow-[0px_0px_100px_10px_rgba(0,0,0,0.25)] bg-neutral-900 rounded-xl border-[1px] border-neutral-900'>
                <div className='flex justify-center mt-[45px] sm:text-[25px]'>
            ...
            <div className='my-5'>
                <div className='flex justify-center'>
                    <div>
                        <a target='_blank' href="https://wa.me/6283468927?text=Hello%20I%20made%20a%20payment%20successfully%20for%20my%20plan%20of%20sonyliv%20and%20here%20is%20the%20screenshot%20of%20payment.%20Please%20activate">
